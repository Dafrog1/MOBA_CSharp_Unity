...
namespace MOBA_CSharp_Server.Game
{
    public class Earthquake : Actor
    {
        ...
        public Earthquake(float debuffDuration, Vector2 direction, float attack, float distance, Vector2 position, float height, float rotation, float radius, UnitType type, int ownerUnitID, Team team, Entity root) : base(position, height, rotation, CollisionType.None, radius, type, ownerUnitID, team, root)
        {
            AddInheritedType(typeof(Earthquake));
